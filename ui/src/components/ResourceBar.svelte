...
{#if $resources}
  ...
  <p class="bnote">Estimated from the models this factory runs — usage outside the factory (e.g. a model you started by hand) isn't counted, so "free" is an upper bound.</p>
{/if}
